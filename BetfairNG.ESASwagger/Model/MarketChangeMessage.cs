...
namespace Betfair.ESASwagger.Model
{
    ...
    public class MarketChangeMessage(
        string Op = null,
        int? Id = null,
MarketChangeMessage.CtEnum? Ct = null,
        string Clk = null,
...
MarketChangeMessage.SegmentTypeEnum? SegmentType = null) : ResponseMessage, IEquatable<MarketChangeMessage>
    {
        ...
        public List<MarketChange> Mc { get; set; } = Mc;
